<?php
	...
	// get cards
	$statement = $db->prepare('SELECT * FROM cards AS c ORDER BY c.order');
	$statement->execute();
...
?>			
	...
	<div id="dialog-delete" class="ui-dialog" title="Contact verwijderen">
		<p>Ben je zeker dat je <span class="target">NAME</span> wil verwijderen? Dit kan niet ongedaan gemaakt worden.</p>
	</div>
